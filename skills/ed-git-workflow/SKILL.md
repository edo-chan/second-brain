---
name: ed-git-workflow
description: Branch, pull request, merge, and release workflow for Ed's repos. Use when making repository changes, committing, pushing, opening or re-requesting review, merging PRs, or cutting and publishing releases.
---
