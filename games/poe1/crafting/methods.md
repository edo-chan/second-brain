# PoE 1 Crafting Methods Reference
...
Calculate method-specific outcome chances with
[probability.md](probability.md). Do not infer probability by multiplying base
weights when the method rolls a complete multi-affix item.
