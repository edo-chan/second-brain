...
- Format context: Starter/Spark deck, later considered for Standard Best-of-One
- Status: Owned snapshot; no longer assumed to be the intended finished deck
...
Observed construction: 38 nonlands, 22 lands, 60 cards. The list mixed Cats
and go-wide payoffs with an Aura/go-tall package. Ed questioned low-impact
one-drops and insufficient single-target interaction.
